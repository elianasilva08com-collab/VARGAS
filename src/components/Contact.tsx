...
const Contact: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const message = `Olá! Gostaria de solicitar um orçamento para os serviços da Vargas Disk Entulhos.
...
Aguardo retorno. Obrigado!`;
    ...
    const whatsappUrl = `https://api.whatsapp.com/send/?phone=5511951627478&text=${encodedMessage}&type=phone_number&app_absent=0`;
  ...
  const contactInfo = [
    {
      icon: Phone,
      title: 'Telefones',
      content: ['(11) 95162-7478'],
    },
    {
      icon: Mail,
      title: 'E-mail',
      content: ['contato@vargasdisketulhos.com'],
    },
    {
      icon: MapPin,
      title: 'Endereço',
      content: ['Avenida Paraná, 3756 - Barção 1, Cajuru do Sul', 'Sorocaba - SP, CEP: 18105-001'],
    },
    {
      icon: Clock,
